...
dfAttrition <- read.csv("C:\\Users\\erico\\Documents\\R\\Space\\HR_Employee_Attrition.csv")

dfAttrition <- dfAttrition %>%
...
dfA2 <- EHPrepare_CreateDummies(dfAttrition, "Attrition")
```

```{r}

EHModel_RandomForest(dfAttrition, "Attrition")
