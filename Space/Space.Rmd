...
```{r}
q <- EHModel_Regression_Logistic(dfTrain5, "Transported", returnLM = TRUE)
predictions_logistic <- EHModel_Predict(q, dfTest5, threshold=.5, testData_IDColumn = "PassengerID")
```
