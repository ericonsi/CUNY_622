...
devtools::install_github("ericonsi/EHData")
#library(EHData)
q <- EHModel_DecisionTree(df3, "highPT", levels=4)
c <- EHModel_SVM(df3, "highPT", method="linear", printPlot=FALSE)
d <- EHModel_RandomForest(df3, "highPT", categorical=TRUE, printPlot=FALSE)
